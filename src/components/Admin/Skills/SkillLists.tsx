...
import CreateSkillsFormModal from "@/components/Admin/Modal/createSkillsFormModal";
  ...
  return (
    <div className="">
      <h1 className="text-2xl md:text-3xl lg:text-4xl font-semibold text-white text-center">
        Did You Learn Something ? Please Add This Skill
      </h1>
      <div className="md:flex md:justify-center md:items-center mt-8">
        <button
          onClick={() => setShowModal(true)}
          className="px-8 p-2 rounded-md bg-pink-700 w-full lg:w-1/4"
        >
          Add Skills
        </button>
        <CreateSkillsFormModal
          modal={showModal}
