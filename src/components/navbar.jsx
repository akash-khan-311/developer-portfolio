  ...
  return (
    ...
    >
      <div className="flex items-center justify-between py-5 container mx-auto ">
        <div className="flex shrink-0 items-center ml-3 lg:ml-6">
          <Link
            href="/"
          ...
          {[
            ...
            <li className="text-sm font-light" key={link.id}>
              <Link
                ...
                className={`inline-block after:contents[""] after:block after:w-0 after:h-0.5 after:bg-[#16f2b3] after:transition-all after:duration-300 after:hover:w-full  transition-colors uppercase hover:text-[#16f2b3]  p-2 ${
