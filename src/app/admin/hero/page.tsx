      ...
      >
        ...
        <div>
          <Field label="Name " required error={errors.name}>
            <input
              {...register("name", { required: "Name Title is Required" })}
              name="name"
              type="text"
              id="name"
        ...
        <div>
          ...
          >
            <input
              ...
              type="text"
              id="facebook"
              placeholder="ex: https://facebook.com/your_profile_id "
              className="w-full px-3 py-2 border bg-slate-900 border-gray-300 rounded-md focus:outline-none focus:border-blue-500"
            />
          </Field>
        </div>
        ...
        <div>
          ...
          >
            <input
              ...
              type="text"
              id="linkedin"
              placeholder="ex: https://linkedin.com/your_profile_id "
              className="w-full px-3 py-2 border bg-slate-900 border-gray-300 rounded-md focus:outline-none focus:border-blue-500"
            />
          </Field>
        </div>
        ...
        <div>
          ...
          >
            <input
              ...
              type="text"
              id="twitter"
              placeholder="ex: https://x.com/your_profile_id "
              className="w-full px-3 py-2 border bg-slate-900 border-gray-300 rounded-md focus:outline-none focus:border-blue-500"
            />
          </Field>
        </div>
        ...
        <div>
          ...
          >
            <input
              ...
              type="text"
              id="github"
              placeholder="ex: https://github.com/your_profile_id "
              className="w-full px-3 py-2 border bg-slate-900 border-gray-300 rounded-md focus:outline-none focus:border-blue-500"
            />
          </Field>
        </div>
        ...
        <div>
          ...
          <div className="flex gap-2">
            ...
            <button
              className={"px-4 py-1 bg-pink-500 rounded-lg"}
              type="button"
              onClick={addIntro}
            >
              Add
          ...
          <ul className="mt-2 space-y-1 inline">
            {slug.map((text, index) => (
              ...
              >
                <span className={"bg-gray-400 px-4 py-1 rounded-lg"}>
                  {text}
                </span>
                <button
                  type="button"
        ...
        <div className="flex items-center justify-between gap-4">
          <button
            className="px-6 py-1 bg-green-500 rounded-md hover:bg-green-600"
            type="submit"
          ...
          <Link
            href="/"
            className="px-6 py-1 bg-pink-700 rounded-md hover:bg-pink-600"
          >
