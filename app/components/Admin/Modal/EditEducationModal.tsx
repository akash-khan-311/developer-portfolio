...
type Props = {
  modalOpen: boolean;
  data: { _id: string; school: string; degree: string; passYear: Date; admitYear: Date };
...
export function EducationModal({ data, modalOpen, setModalOpen, mutate }: Props) {
        ...
        <div className="">
          ...
          <div className="md:flex md:justify-center md:items-center mt-5">
            <form onSubmit={handleSubmit(onSubmit)} action="">
              <div>
                <Field htmlFor="school" label="School Name" required error={errors.school}>
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  <Field htmlFor="admitYear" label="Admit Year Date" required error={errors.admitYear}>
                    <input
                      {...register("admitYear", {
                ...
                <div>
                  <Field htmlFor="passYear" label="End Date" required error={errors.passYear}>
