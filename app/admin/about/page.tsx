...
const AboutPage = () => {
  ...
  const submitForm = async (data: { description: string; profileImage: FileList }) => {
        ...
        <form onSubmit={handleSubmit(submitForm)}>
          <div>
            <Field htmlFor="description" label="Description" required error={errors.description}>
              ...
              })} rows={5} id="description" name="description" className='w-full px-3 py-2 border bg-slate-900 border-gray-300 rounded-md focus:outline-none focus:border-blue-500' />
            </Field>
          </div>
          <div>
            ...
            <Field htmlFor="profileImage" label="Profile Image" required error={errors.profileImage}>
              <input   {...register("profileImage", {
                ...
                type="file"
                accept="image/*"
                onChange={loadFile} className='w-full px-3 py-10 border bg-slate-900 border-gray-300 rounded-md focus:outline-none focus:border-blue-500' />
            </Field>

          </div>
          <div className="mt-5">
            <button className=" bg-green-700 hover:bg-green-500 transition-all duration-300 rounded-md text-lg px-8 py-1 " type="submit">
